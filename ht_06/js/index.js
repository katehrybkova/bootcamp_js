...
class Hamburger {
  ...
  if(this._toppings.length > 0) {
    for(let x of this._toppings) {
      summ = summ + Hamburger.TOPPINGS[x].price;
    }
    return summ + stuff
  } return stuff
    }
  ...
  // }
     ...
     */
    calculateCalories() {let stuff = Hamburger.SIZES[this._size].calories + Hamburger.STUFFINGS[this._stuffing].calories;
      let summ = 0;
      if(this._toppings.length > 0) {
        for(let x of this._toppings) {
          summ = summ + Hamburger.TOPPINGS[x].calories;
        }
        return summ + stuff
      } return stuff
        }}
  ...
  */
  ...
  Hamburger.TOPPINGS[Hamburger.TOPPING_SPICE].price
