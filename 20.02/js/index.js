...
//====================================continue
// let i = 0;
// const users = ['Alex', 'Nikolay', 'Helen', 'Kate'];
// do {
//     if(users[i] === 'Helen') {
...
//     return `Уважаемый(-ая) - ${name}, до начала отпуска осталось ${days} тестовых дня(ей)`;
//   }
...
const summ = function() {
    const max = arguments.length; //колличество элементов псевдомасива argument
    let total = 0;
