...
//  */
const getTotalBalance = arr => arr.reduce((acc, input) =>  acc + input.balance , 0)
//     ...
// };
...
//  */
const getUsersByFriend = (arr, name) => arr.filter(input => input.friends.includes(name)).map(input => input.name)
//     ...
// };
